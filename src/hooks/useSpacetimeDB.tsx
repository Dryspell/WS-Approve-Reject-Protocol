    ...
    const onConnect = (connection: DbConnection, clientIdentity: Identity, token: string) => {
      ...
      connection
        ...
        .subscribe([
          ...
          // Colony / combat / meta systems (consumed by VotingInterface)
          'SELECT * FROM equipment',
          'SELECT * FROM battle_arena',
          'SELECT * FROM battle_unit',
          'SELECT * FROM battle_combat_event',
          'SELECT * FROM side_bet',
          'SELECT * FROM laborer_genetics',
          'SELECT * FROM tournament',
          'SELECT * FROM owned_laborer',
          'SELECT * FROM owned_equipment',
          'SELECT * FROM player_stash',
          'SELECT * FROM roster_pick',
